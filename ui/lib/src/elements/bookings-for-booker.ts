 ...
 */
@localized()
@customElement('bookings-for-booker')
export class BookingsForBooker extends LitElement {
    ...
    switch (this._bookings.value.status) {
      ...
      case 'complete':
        ...
        return html` <div class="column" style="flex: 1">
          <span class="title">${msg('Upcoming')}</span>
          <sl-divider></sl-divider>
          ${this.renderList(future)}

          <span class="title" style="margin-top: 16px">${msg('Past')}</span>
          <sl-divider></sl-divider>
